...
function FilterSection({ onFilter }) {
    return (
        <div className="flex flex-wrap gap-9 my-[24px] text-base rounded-none text-zinc-700">
            <form className="overflow-hidden flex-auto gap-1 self-stretch p-3 bg-white rounded border border-solid border-stone-300 min-h-[44px] w-[943px] max-md:max-w-full">
