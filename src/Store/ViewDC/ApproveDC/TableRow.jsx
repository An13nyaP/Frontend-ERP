  ...
  return (
    <div className="flex flex-wrap gap-4 justify-center items-center p-4 w-full bg-white border-b-2 border-blue-100 max-md:max-w-full">
      ...
      <div className="flex flex-1 shrink gap-2 items-center self-stretch my-auto basis-0">
        <div className="gap-2.5 self-stretch px-3 py-2 my-auto bg-blue-100 text-blue-600 text-xs font-medium rounded-3xl text-center cursor-pointer">
          Open
        </div>
      </div>
      <div className="flex flex-1 shrink gap-2 items-center self-stretch my-auto basis-0">
        <div
          className={`gap-2.5 self-stretch px-3 py-2 my-auto ${approval === "Approved"
            ? "bg-emerald-50 text-green-600"
            : "bg-red-100 text-red-600"
            } text-xs font-medium rounded-3xl text-center`}
        >
          {approval}
        </div>
      </div>
