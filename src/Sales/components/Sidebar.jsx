...
const menuItems = [
  ...
  { name: "Request For Quotations", isActive: false },
  { name: "Customer's", isActive: false },
  { name: "Quotation's", isActive: false },
  { name: 'Add PO Inward', isActive: false },
  { name: 'Project Acceptance Status', isActive: false },
]
