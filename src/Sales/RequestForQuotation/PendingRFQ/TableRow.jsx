...
function TableRow({
  ...
  return (
    <div className="flex flex-wrap gap-4 justify-center items-center p-4 w-full bg-white border-b-2 border-blue-100 max-md:max-w-full">
      ...
      <div className="flex flex-1 shrink items-center my-auto text-xs font-medium text-yellow-600 whitespace-nowrap basis-0">
        <div className="px-3 py-2 bg-yellow-100 rounded-3xl">
