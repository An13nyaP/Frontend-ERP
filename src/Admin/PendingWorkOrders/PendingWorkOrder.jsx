...
import PendingPOsTable from "./PendingWorkOrdersTable";

function PendingWorkOrdersPage() {
  return (
    <div className="flex overflow-hidden flex-wrap gap-4 bg-slate-50">
      <div className="flex flex-col grow shrink-0 basis-0 w-fit max-md:max-w-full">
        <main className="flex flex-col px-5 py-2 w-full bg-white shadow-[4px_4px_40px_rgba(0,0,0,0.15)] max-md:pl-5 max-md:max-w-full">
          <FilterSection />
