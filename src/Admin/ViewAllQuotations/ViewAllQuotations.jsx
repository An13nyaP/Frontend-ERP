  ...
  return (
    <div className="flex overflow-hidden flex-wrap gap-6 bg-slate-50">
      <main className="flex flex-col grow shrink-0 basis-0 w-fit max-md:max-w-full">
        <FiltersSection />
        <section className="flex flex-col pt-12 pb-24 pl-8 w-full bg-white shadow-[4px_4px_40px_rgba(0,0,0,0.15)] max-md:pl-5 max-md:max-w-full">
          <header className="flex flex-wrap gap-5 justify-between mr-10 w-full text-2xl font-medium tracking-wide text-black max-w-[1149px] max-md:mr-2.5 max-md:max-w-full">
            ...
            <img
              ...
              className="object-contain shrink-0 self-start rounded-none aspect-square w-[35px]"
              alt=""
            />
          </header>
          <QuotationsTable />
